    ...
    <div class="content">
      <div class="filter-container">
        ...
        <el-form :model="qc" :inline=true class="clear">
         ...
         <div>
           ...
           <div>
             <el-button size="small" type="primary" icon="el-icon-search" @click="query(1,$store.state.countryBloodPageSize)">查询</el-button>
      ...
      <div >
        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              <el-button type="text" class="btnStyle" size="small"  @click="showData(scope.row)" v-if="scope.row.collectStatus == 1">查看</el-button>
              <!-- 解除锁定组件 -->
          ...
          <el-col :span="14"><div class="grid-content bg-purple">
            <div class="block" style="margin-top: 18px">
              <el-pagination
                ...
                :current-page="$store.state.countryBloodPageNo"
                :page-sizes="[10, 20, 50, 100]"
                v-bind:page-size="$store.state.countryBloodPageSize"
...
import DICTIONARY from "@/utils/dictionary.js";
  export default {
    ...
    mounted(){
      ...
      this.query(this.$store.state.countryBloodPageNo,this.$store.state.countryBloodPageSize);
    },
    beforeDestroy(){
      this.$store.state.countryBloodPageNo=1;
      this.$store.state.countryBloodPageSize=10;
    },
    methods:{
      //获取选中社区
      getQcId(value){
      ...
      query(pageNo,pageSize){
        $axios_http({
          ...
          this.$store.commit('get_countryBloodListPageNo',pageNo)
      ...
      pageSizeChange(pageSize) {
        this.$store.commit('get_countryBloodListPageSize', pageSize)
        //this.queryResult.pageSize = pageSize
        this.query(this.$store.state.countryBloodPageNo,pageSize);
      },
      //切换当前页事件，做重新查询操作
      currentPageChange(currentPage) {
        this.$store.commit('get_countryBloodListPageNo',currentPage)
        //this.queryResult.pageNo = currentPage
        this.query(currentPage,this.$store.state.countryBloodPageSize);
      }
