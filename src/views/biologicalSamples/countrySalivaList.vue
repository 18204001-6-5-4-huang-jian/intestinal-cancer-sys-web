      ...
      <div class="filter-container">
        ...
        <el-form :model="qc" :inline=true class="clear">
         ...
         <div>
           ...
           <div>
             <el-button size="small" type="primary" icon="el-icon-search" @click="query(1,$store.state.countrySalivaListPageSize)">查询</el-button>
          ...
          <el-col :span="14"><div class="grid-content bg-purple">
            <div class="block" style="margin-top: 18px">
              <el-pagination
                ...
                :current-page="$store.state.countrySalivaListPageNo"
                :page-sizes="[10, 20, 50, 100]"
                v-bind:page-size="$store.state.countrySalivaListPageSize"
  ...
  export default {
    data () {
      return {
        ...
        downloadUrl: SERVER_NAME + '/base/hospital/sample/stoolSampleQueryExcel?type=saliva',
        btnAuth:{
    ...
    mounted(){
      ...
      this.query(this.$store.state.countrySalivaListPageNo,this.$store.state.countrySalivaListPageSize);
    },
    beforeDestroy(){
      this.$store.state.countrySalivaListPageNo=1;
      this.$store.state.countrySalivaListPageSize=10;
    },
    methods:{
      //获取选中社区
      getQcId(value){
      ...
      query(pageNo,pageSize){
        $axios_http({
          ...
          vueObj:this
           ...
           this.$store.commit('get_countrySalivaListPageNo',pageNo)
      ...
      pageSizeChange(pageSize) {
        this.$store.commit('get_countrySalivaListPageSize', pageSize)
        //this.queryResult.pageSize = pageSize
       this.query(this.$store.state.countrySalivaListPageNo,pageSize);
      },
      //切换当前页事件，做重新查询操作
      currentPageChange(currentPage) {
        this.$store.commit('get_countrySalivaListPageNo',currentPage)
        //this.queryResult.pageNo = currentPage
        this.query(currentPage,this.$store.state.countrySalivaListPageSize);
      }
