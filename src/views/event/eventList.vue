    ...
    <div class="content">
      <div class="filter-container">
        ...
        <el-form :model="qc" :inline="true" class="clear">
            ...
            <el-select v-model="qc.cancerReportStatus" placeholder="表单录入状态" size="small" class="filter-item" clearable v-if="qc.cancerType==1">
              <el-option value="1" v-bind:key="1" label="未录入"></el-option>
              <el-option value="2" v-bind:key="2" label="已录入"></el-option>
            </el-select>
            <el-select v-model="qc.cancerDiagnoseStatus" placeholder="表单录入状态" size="small" class="filter-item" clearable v-if="qc.cancerType==2">
              <el-option value="1" v-bind:key="1" label="未录入"></el-option>
              <el-option value="2" v-bind:key="2" label="已录入"></el-option>
            </el-select>
            <el-select v-model="qc.colorectalCancerDiagnoseInformationStatus" placeholder="表单录入状态" size="small" class="filter-item" clearable v-if="qc.cancerType==3">
              <el-option value="1" v-bind:key="1" label="未录入"></el-option>
              <el-option value="2" v-bind:key="2" label="已录入"></el-option>
            </el-select>
            <el-select v-model="qc.colorectalCancerTreatmentInformatioStatus" placeholder="表单录入状态" size="small" class="filter-item" clearable v-if="qc.cancerType==4">
              <el-option value="1" v-bind:key="1" label="未录入"></el-option>
              <el-option value="2" v-bind:key="2" label="已录入"></el-option>
            </el-select>
            <el-date-picker
        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              ...
              <div v-if="qc.cancerType==5">
                <router-link :to="{path:'/event/cancerReport5',query:{id:scope.row.deathCertificateId,flag:0}}"  v-if="scope.row.deathCertificateStatus==2">
                  <el-button type="text">查看</el-button>
                </router-link>
                <router-link :to="{path:'/event/cancerReport5',query:{
                id:scope.row.deathCertificateId,
                flag:2,resource:1}}"  v-if="scope.row.deathCertificateStatus==2 && ($store.state.hospitalType==2 || $store.state.hospitalType==1)">
                  <el-button type="text">编辑</el-button>
                </router-link>
                <router-link :to="{path:'/event/cancerReport5',query:{sid:scope.row.sid,
                deathCertificateId:scope.row.deathCertificateId,
                flag:1,resource:1}}" v-if="scope.row.deathCertificateStatus==1 && ($store.state.hospitalType==2 || $store.state.hospitalType==1)">
                  <el-button type="text">录入</el-button>
                </router-link>
              </div>
    ...
    query(pageNo, pageSize) {
      ...
      $axios_http({
        ...
        data: {
          ...
          colorectalCancerDiagnoseInformationStatus: this.qc
            .colorectalCancerDiagnoseInformationStatus,
          colorectalCancerTreatmentInformatioStatus: this.qc
            .colorectalCancerTreatmentInformatioStatus,
