<template>
  <div slot="right" class="content-page" v-if="stayEntryPathology_page">
    <div class="content">
      <div class="filter-container" >
        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              <router-link :to="{path:'/colonscopy/report2',query:{id:scope.row.id,sid:scope.row.sid}}"><el-button type="text" class="btnStyle" size="small">录入病理结果</el-button></router-link>
            </template>
          </el-table-column>
        </el-table>
        <!--分页栏-->
...
//          buttonUserRoleDis:false
    ...
    mounted(){
      ...
      let obj = this.checkPageAuth(this,"stayEntryPathology_page",this.btnAuth);
    ...
    methods:{
     ...
     query(pageNo,pageSize){
        $axios_http({
          url:"/base/hospital/person/notentry/pathology/result/query",
          data:{
            name:this.qc.name,
            sid:this.qc.sid,
            phone:this.qc.phone,
