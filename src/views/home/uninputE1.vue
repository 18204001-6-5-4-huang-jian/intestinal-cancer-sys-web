<template>
    <div slot="right" class="content-page" v-if="uninput_e1_page">
        <div class="content">
      <div class="filter-container">
        ...
        <router-link to="/home/home">
         ...
         <el-form :model="formData" class="clearfix" :inline="true">
          ...
          <el-button  size="small" type="primary" icon="el-icon-search" @click="query(1,$store.state.uninputE1ListPageSize)" >查询</el-button>
          ...
          <el-col :span="14"><div class="grid-content bg-purple">
            <div class="block" style="margin-top: 18px">
              <el-pagination
                ...
                :current-page="$store.state.uninputE1ListPageNo"
                :page-sizes="[10, 20, 50, 100]"
                v-bind:page-size="$store.state.uninputE1ListPageSize"
...
import DICTIONARY from "@/utils/dictionary.js";
  export default {
    ...
    mounted(){
      let obj = this.checkPageAuth(this,"uninput_e1_page",this.btnAuth) 
       this.query(this.$store.state.uninputE1ListPageNo,this.$store.state.uninputE1ListPageSize);
    },
    methods:{
        getQcId(value){
        ...
        reset(){
          ...
          $axios_http({
            url:'/base/follow/hospital/contactRecord/notEntry',
            data:dataobj,
            vueObj:this
          }).then((res) => {
             if(res.data.statusMsg == 'success'){
                   ...
                   this.$store.commit('get_uninputE1ListPageNo',res.data.data.pageNum)
                }
          })
        },
       ...
       pageSizeChange(val){
          this.$store.commit('get_uninputE1ListPageSize', val);
          this.query(this.$store.state.uninputE1ListPageNo,val);
       },
       currentPageChange(val){
          this.$store.commit('get_uninputE1ListPageNo', val);
          this.query(val,this.$store.state.uninputE1ListPageSize);
       },
       input(row){
