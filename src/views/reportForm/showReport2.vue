<template>
  <div class="j_content jright" v-if="showReport2_page">
    <div style="min-width: 1200px;">
              ...
              <div>
                <div>
                  <table class="j_table cmc">
                    ...
                    <div v-for="(x,index) in colonoscopyPathologyDiagnosisRecordList" :key="index">
                        ...
                        <tr>
                            <td width="140">
                                <el-form-item label=" " prop="item1" style="margin-bottom:0;margin-right: 0;" >
                                  <el-input v-model="x.item1"  size="small" style="width:100px;" :disabled="x.disabled"></el-input>
                                </el-form-item>
                            </td>
                            <td width="140">
                              <el-form-item label=" " prop="item2" style="margin-bottom:0;margin-right: 0;">
                                <el-select v-model="x.item2" placeholder="请选择" size="small" style="width:102px;" :disabled="x.disabled">
                                  <el-option
                            ...
                            <td width="128">
                              <el-form-item label=" " prop="item3" class="formoneline specialwidth2" style="margin-bottom:0;margin-right: 0;" >
                                <el-input v-model="x.item3"  size="small" style="width:90px;" :disabled="x.disabled">
                            ...
                            <td width="100" v-if="!show">
                              <el-button type="text" size="small" @click="clearbbFun(index)" :disabled="x.disabled">清空</el-button>
                              <el-button type="text" size="small" @click="delbbFun(index)" :disabled="x.disabled">删除</el-button>
                            </td>
                        </tr>
                      </el-form>
                    </div>
      ...
      <div class="text-center" style="margin-top: 40px;" v-if="ShowData">
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      return {
        approvalArr:{
          formType:"HOSPITAL_COLONOSCOPY_PATHOLOGY_RESULT",
        },  //解除锁定相关信息
        ShowData:null,
        arr:[],
        users:{
    ...
    created() {
      let obj = this.checkPageAuth(this,"showReport2_page",this.btnAuth)
      this.formInline.sid=this.$route.query.sid;
      this.formInline.id = this.$route.query.id;
      this.show = this.$route.query.show==1?true:false
      this.getReport1()
      this.queryDetail()
      if(this.show){
        this.queryInfo()
          ...
          vueObj:this
            ...
            if(res.data.data.lesionsRecordList){
              for(let i =0;i<res.data.data.lesionsRecordList.length;i++){
                if(res.data.data.lesionsRecordList[i].item4 != ''&& res.data.data.lesionsRecordList[i].item4 != null && res.data.data.lesionsRecordList[i].item4 != undefined){
                  var obj ={}
