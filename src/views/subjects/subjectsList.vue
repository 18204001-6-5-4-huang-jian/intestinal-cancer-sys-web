        ...
        <el-table
          ...
          >
            <template slot-scope="scope">
              ...
              <el-button type="text" 
              v-if="btnAuth.subjectsList_EXCEL_btn && scope.row.followState==3 && scope.row.overallStatusCy !=2" 
              @click="openQuitDialog(scope.row)">违反方案</el-button>
              <el-button type="text" v-if="btnAuth.subjectsList_EXCEL_btn && scope.row.violationPlanStatusCy ==1 " @click='openInsertDialog(scope.row.sid)'>取消违反</el-button>
